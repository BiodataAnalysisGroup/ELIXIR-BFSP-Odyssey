...
hometextUi     <- function(id) {
    moduleServer(id, function(input, output, session) {
        ...
        <div>
          <img src='https://raw.githubusercontent.com/BiodataAnalysisGroup/ELIXIR-BFSP-Odyssey/main/inst/pic/logo_nobg.png' width='250' alt='Odyssey Logo' style='float: right; margin-top: -50px; margin-right: -20px;'/>
